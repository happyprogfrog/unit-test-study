...
import me.progfrog.unit_test_study.article.adapter.in.api.dto.BoardDto;
...
class ArticleServiceTest {
    ...
    class ModifyArticle {
        ...
        @Test
        @DisplayName("존재하지 않는 Article이면 NoSuchElementException throw")
